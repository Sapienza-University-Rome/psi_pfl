...
def main():
    ...
    parser_main.add_argument('--non-iid-param', type=float, default=1, help='Non-IID parameter (either alpha for Dirichlet or S for similarity) to split data')
    ...
    parser_main.add_argument('--seeds-list', type=str, default="42,0", help='List of random seeds to use for training (comma separated)')
    parser_main.add_argument('--local-epochs', type=int, default=2, help='Number of local epochs (per client)')
    parser_main.add_argument('--comm-rounds', type=int, default=2, help='Number of communication rounds in FL training')   
    parser_main.add_argument('--psi-ths-list', type=str, default="10,20", help='List of percentiles for psi thresholds (tau) (comma separated)')
